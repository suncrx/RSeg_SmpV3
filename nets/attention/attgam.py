# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 20:06:58 2025

@author: renxi

A global attention mechanism that boosts the performance of deep neural networks 
by reducing information reduction and magnifying the global interactive 
...
class GAM(nn.Module):
    def __init__(self, in_channels, out_channels, rate=4):
        ...
        self.conv1=nn.Conv2d(in_channels, inchannel_rate,
                             kernel_size=7,padding=3,
                             padding_mode='replicate')

        self.conv2=nn.Conv2d(inchannel_rate, out_channels,
                             kernel_size=7,padding=3,
                             padding_mode='replicate')
